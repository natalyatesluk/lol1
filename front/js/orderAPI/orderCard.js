...
export const  orderCardRender = (order) => {
    ...
    <div class="order-info">
        <div class="order-resep-info">
            ...
            <div class="order-resep-info-item order-address"><b>Delivery address:</b> <br> ${order.city}, ${order.remark}.Office of Nova Poshta:${order.post_office}</div>
...
function orderCartItemRender(item, order) {
    ...
    cartItem.innerHTML = `  <div class="cart-img-container">
                            ...
                            <div class="cart-product-info order-details">
                                ...
                                <div class="cart-product-insertion">${item.product.insertion}</div>
                                <div class="cart-product-size">${item.product.size} cm</div>
