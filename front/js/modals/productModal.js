...
const productModalContent = `<form name="productForm" enctype="multipart/form-data">
    ...
    <table class="form-table">
        ...
        <tr>
            ...
            <td class="form-input"><input type="text" name="productProducer" id="productProducer" class="form-control" required></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="form-input">
                <select name="productMaterial" id="productMaterial" class="form-select" required>
                    <option>Silver 625</option>
                    <option>Gold</option>
                    <option>White Gold</option>
                    <option>Medical alloy</option>
                    <option>Pearl</option>
                </select>
            </td>
        </tr>
        <tr>
            <td class="form-label"><label for="productInsertion">Insertion:</label> </td>
            <td class="form-input">
                <select name="productInsertion" id="productInsertion" class="form-select" required>
                    <option>None</option>
                    ...
                    <option>Mountain Stone</option>
                    <option>Fianit</option>
                    <option>Pearl</option>
        ...
        <tr>
        <td class="form-label"><label for="productSize">Size cm:</label> </td>
        <td class="form-input"><input type="number" name="productSize" id="productSize" class="form-control" required></td>
    </tr>
        <tr>
            <td></td>
