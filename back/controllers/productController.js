    ...
    try {
        productForm.parse(req, async (err, fields, files) => {
            try {
                ...
                const { productId, producCategory,productProducer, productName,  productMaterial,productInsertion, productSize,productPrice, oldCloudinaryPublicId, oldImagePath } = fields;
